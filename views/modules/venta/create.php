                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-shopping-cart"></i> &nbsp; Información de la venta
                                    <?= $nameModel ?></h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" id="frmCreate<?= $nameModel ?>" name="frmCreate<?= $nameModel ?>"
                                    ...
                                    if (!empty($dataVenta)) {
                                        ?>
                                        <div class="form-group row">
                                            <label for="numero_serie" class="col-sm-4 col-form-label">Id_Venta
                                                nombre</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="numero_serie" class="col-sm-4 col-form-label">Valor_Total</label>
                                            <div class="col-sm-8">
                                                <?= $dataVenta->getmonto() ?>
                                            </div>
                                        </div>
                                    <div class="form-group row">
                                        <label for="numero_serie" class="col-sm-4 col-form-label">Metodo_Pago</label>
                                        <div class="col-sm-8">
                                            <?= $dataVenta->getmetodo_pago() ?>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label for="usuario_id" class="col-sm-4 col-form-label">Persona_Documento</label>
                                                <div class="col-sm-8">
                                                    <?= $dataVenta->usuario_id() ?>
                                    <?php } ?>
                                    <hr>
                    ...
                    <div class="col-md-8">
                        <div class="card card-lightblue">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-parachute-box"></i> &nbsp; Venta</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="card-refresh"
                                            data-source="create.php" data-source-selector="#card-refresh-content"
                                            data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>
                                        ...
                                        <div class="col-auto">
                                            <a role="button" href="#" data-toggle="modal" data-target="#modal-add-producto"
                                               ...
                                               style="margin-right: 5px;">
                                                <i class="fas fa-plus"></i> Añadir venta
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="row">
                                    <div class="col">
                                        <table id="tblVenta"
                                            ...
                                            <?php
                                            if (!empty($_GET['id'])) {
                                                $arrVenta = Venta::search("SELECT * FROM weber.venta WHERE venta_id = ".$_GET['id']);
                                                if(count($arrVenta) > 0) {
                                                    ...
                                                    foreach ($arrDetalleVentas as $Venta) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $Venta->getfecha()->getfecha(); ?></td>
                                                            <td><?= $venta->getvalor_total(); ?></td>
                                                            <td><?= $Venta->getmetodo_pago(); ?></td>
                                                            <td><?= $Venta->getestado(); ?></td>
                                                            <td><?= $Venta->getusuario_id(); ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $Venta->getId(); ?>"
                ...
                <div class="modal-content">
                    ...
                    <form action="../../../app/Controllers/MainController.php?controller=DetalleVentas&action=create" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="venta_id" class="col-sm-4 col-form-label">venta</label>
                                <div class="col-sm-8">
    ...
    $(function () {
        ...
        function updateDataProducto(dataProducto){
            if(dataProducto !== null){
                $("#divid_venta").slideDown();
                $("#spfecha").html("$"+dataProducto.fecha);
                $("#svalor_total").html("$"+dataProducto.valor_total);
                $("#metodo_pago").html(dataProducto.metodo_pago+" Unidad(es)");
                $("#estado").attr("max",dataProducto.estado);
                $("#usuario_id").attr("max",dataProducto.usuario_id);
                ...
                $("#spvalor_total").html("");
                $("#spmetodo_pago").html("");
                $("#estado").removeAttr("max").val('0');
                $("#usuario_id").removeAttr("max").val('0');
               ');
            }
        }
