...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Gestión de Venta<?= $pluralModel ?></title>
                                        ...
                                        <table id="tbl<?= $nameModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            foreach ($arrVenta as $venta) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $venta->getfecha()->getFecha(); ?> <?= $venta->getCliente()->getApellidos(); ?></td>
                                                    <td><?= $venta->getvalor_total()->getNombres(); ?> <?= $venta->getEmpleado()->getApellidos(); ?></td>
