...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Editar Produccion</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= $baseURL; ?>/views/">Producciom</a></li>
            ...
            <?php if (!empty($_GET['respuesta'])) { ?>
                <?php if ($_GET['respuesta'] != "correcto") { ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al crear el Produccion: <?= $_GET['mensaje'] ?>
                    </div>
                <?php } ?>
            <?php } ?>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <p>
                                <?php
                                $Dataproduccion = ProduccionController::searchForID($_GET["id"]);
                                if (!empty($Dataproduccion)) {
                                ?>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="post" id="frmEditCarro"
                                      name="frmEditCarro"
                                      action="../../../app/Controllers/ProduccionController.php?action=edit">
                                    <input id="id" name="id" value="<?php $Dataproducto ='';
                                    echo $Dataproducto->getid_produccion(); ?>" hidden
